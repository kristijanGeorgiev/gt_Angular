...
@Component({
  selector: 'app-employee-assigned-booking',
  standalone: false,
  templateUrl: './employee-assigned-booking.component.html',
  styleUrl: './employee-assigned-booking.component.css'
})
export class EmployeeAssignedBookingComponent {
  bookings: Booking[] = [];
